...
confeds %>%
  ...
  ggplot(aes(year, count)) +
    ...
    geom_vline(xintercept = as.Date("1945-05-07", origin = "1970-01-01"),
               color = "lightgrey", linetype = "dashed"
    ) + # world war 2
    geom_col(width = 365, alpha = 0.75, fill = "#e41a1c", color = "black") +
    labs(
...
<center>
<iframe width="560" height="560" src="https://www.youtube.com/embed/55ehKPUm7dc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</center>
...
confeds %>%
  ...
  ggplot(aes(n, fct_reorder(category, n))) +
    geom_col(fill = "#e41a1c", color = "black", width = 0.7, alpha = 0.75) +
    labs(
