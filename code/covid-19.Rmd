...
For the purpose of assisting the global COVID-19 pandemic response, Google has temporarily made available detailed mobility estimates relative to local baselines obtained from cell phone and other data of the type used by traffic, etc., services like Google Maps and Waze. This data is provided by Google in the form of [Community Mobility Reports](https://www.google.com/covid19/mobility/).
