...
us %>% 
  ggplot(mapping = aes(x = date)) +
    ...
    labs(
      ...
      y = "cases (change)",
      fill = "",
      caption = "(data from nytimes and johns hopkins univ.)"
    ) +
    scale_y_continuous(
      labels = scales::comma
    ) +
